...
public class TourbillonAlternatif : MonoBehaviour
{
    ...
    public void CheckDeplacement()
    {
        ...
        nextPos.transform.RotateAround(otherPlayer.position, Vector3.right, rotationSens * angleSpeed * Time.deltaTime);
    ...
    public void TourbillonSkill()
    {
        ...
        CheckDeplacement();
        transform.RotateAround(otherPlayer.position, Vector3.right, rotationSens * angleSpeed * Time.deltaTime);
